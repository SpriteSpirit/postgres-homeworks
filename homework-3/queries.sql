...
SELECT customers.company_name, employees.first_name || ' ' || employees.last_name as employee_fullname
FROM orders
...
SELECT product_name, units_in_stock, suppliers.contact_name, suppliers.phone, discontinued
FROM products
